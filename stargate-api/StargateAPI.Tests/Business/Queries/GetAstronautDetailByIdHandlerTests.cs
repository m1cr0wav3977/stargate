...
{
    public class GetAstronautDetailByIdHandlerTests
    {
        [Fact]
        public async Task Handle_WhenDetailExists_ShouldReturnDetail()
        {
            ...
            var handler = new GetAstronautDetailByIdHandler(context);
            var request = new GetAstronautDetailById { Id = detail.Id };
            ...
            result.AstronautDetail!.Id.Should().Be(detail.Id);
        ...
        public async Task Handle_WhenDetailDoesNotExist_ShouldReturnNull()
        {
            ...
            using var context = TestDbContextHelper.CreateInMemoryContext();
            var handler = new GetAstronautDetailByIdHandler(context);
            var request = new GetAstronautDetailById { Id = 999 };
